...
dfTemp1 <- df_raw %>%
  ...
  mutate(Adaptation = factor(ifelse(grepl("NonAd",thisRCP), "Not_adapted_sow", "Adapted_sow"))) %>%
  mutate(Adaptation=factor(Adaptation, levels=c("Not_adapted_sow","Adapted_sow"))) %>%
...
- Average of all 20 years per pixel
